...
export type RoomSeatSummary = Readonly<{
    seat: number;
    playerId: string;
    name: string;
}> | null;
export type ReservedSeatSummary = Readonly<{
    seat: number;
    playerId: string;
    name: string;
...
export type VisibleHand = Readonly<{
    kind: "visible";
    cards: ReadonlyArray<Readonly<{
        uid: string;
        suit: string;
        rank: string;
    }>>;
